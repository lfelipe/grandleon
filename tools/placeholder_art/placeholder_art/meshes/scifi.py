...
TROOPER: Tuple[Part, ...] = (
    Part(-13,  -4,   0,   6,  -8,   8, RAMP_NEUTRAL, 0, "left boot"),
    Part(  4,  13,   0,   6,  -8,   8, RAMP_NEUTRAL, 0, "right boot"),
    Part(-12,  -5,   6,  40,  -6,   6, RAMP_NEUTRAL, 1, "left shin"),
    Part(  5,  12,   6,  40,  -6,   6, RAMP_NEUTRAL, 1, "right shin"),
    Part(-12,  -4,  38,  62,  -7,   7, RAMP_NEUTRAL, 1, "left thigh"),
    Part(  4,  12,  38,  62,  -7,   7, RAMP_NEUTRAL, 1, "right thigh"),
    Part(-24, -10,   8,  78, -18, -12, RAMP_FACTION, 3, "slab shield"),
    Part(-13,  13,  60,  72,  -8,   8, RAMP_FACTION, 1, "hip armour"),
    Part( 13,  17,  70,  92,  -6,   6, RAMP_NEUTRAL, 1, "right arm"),
    Part(-17, -13,  72,  96,  -6,   6, RAMP_NEUTRAL, 1, "left arm"),
    Part(-13,  13,  70, 102,  -9,   9, RAMP_FACTION, 1, "faction suit"),
    Part( 12,  26,  80,  86, -12,  -4, RAMP_NEUTRAL, 2, "carbine, barrel"),
    Part( 24,  30,  78,  90, -14,  -4, RAMP_NEUTRAL, 3, "carbine, muzzle vent"),
    Part( -9,   9,  76,  98, -11,  -9, RAMP_NEUTRAL, 1, "chest plate"),
    Part(-19, -11,  96, 108,  -9,   9, RAMP_FACTION, 2, "left pauldron"),
    Part( 11,  19,  96, 108,  -9,   9, RAMP_FACTION, 2, "right pauldron"),
    Part( -6,   6, 100, 106,  -5,   5, RAMP_NEUTRAL, 0, "gorget"),
    Part( -9,   9, 104, 128,  -9,   9, RAMP_NEUTRAL, 1, "sealed helm"),
    Part( -9,   9, 110, 116, -11,  -9, RAMP_NEUTRAL, 3, "visor slit"),
)
...
SNIPER: Tuple[Part, ...] = (
    Part(-11,  -3,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "left boot"),
    Part(  3,  11,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "right boot"),
    Part(-10,  -4,   6,  38,  -5,   5, RAMP_NEUTRAL, 1, "left shin"),
    Part(  4,  10,   6,  38,  -5,   5, RAMP_NEUTRAL, 1, "right shin"),
    Part(-10,  -3,  36,  60,  -6,   6, RAMP_NEUTRAL, 0, "left thigh"),
    Part(  3,  10,  36,  60,  -6,   6, RAMP_NEUTRAL, 0, "right thigh"),
    Part(-24, -18,  30,  66, -18, -14, RAMP_NEUTRAL, 1, "rail, brace"),
    Part(-11,  11,  58,  96,  -7,   7, RAMP_FACTION, 3, "torso"),
    Part(-16, -11,  66,  90,  -6,   6, RAMP_FACTION, 1, "left arm"),
    Part(-24,   2,  66,  72, -18, -14, RAMP_NEUTRAL, 1, "rail, breech"),
    Part( 11,  16,  70,  94,  -6,   6, RAMP_FACTION, 1, "right arm"),
    Part( -2,  27,  72,  78, -18, -14, RAMP_NEUTRAL, 2, "rail, barrel"),
    Part( 26,  32,  70,  82, -20, -12, RAMP_NEUTRAL, 3, "rail, muzzle"),
    Part( -6,   6,  94, 110,  -6,   6, RAMP_NEUTRAL, 2, "head"),
    Part( -8,   8, 100, 118,  -6,   8, RAMP_FACTION, 2, "cowl"),
    Part(  0,   8, 104, 110, -10,  -6, RAMP_NEUTRAL, 3, "targeting monocle"),
    Part( -4,   4, 112, 128,  -2,  10, RAMP_FACTION, 2, "cowl point"),
)
...
PSION: Tuple[Part, ...] = (
    Part( -8,   8,   0,  12,  -6,   6, RAMP_NEUTRAL, 3, "hover flare"),
    Part( -6,   6,  10,  24,  -4,   4, RAMP_NEUTRAL, 2, "hover column"),
    Part(-11,  11,  22,  42,  -7,   7, RAMP_FACTION, 1, "robe, point"),
    Part(-17,  17,  40,  64,  -9,   9, RAMP_FACTION, 2, "robe, skirt"),
    Part(-24, -18,  46,  56,  -8,   0, RAMP_NEUTRAL, 2, "left hand, open"),
    Part( 18,  24,  46,  56,  -8,   0, RAMP_NEUTRAL, 2, "right hand, open"),
    Part(-18, -10,  52,  66,  -4,   4, RAMP_FACTION, 2, "left sleeve, out and down"),
    Part( 10,  18,  52,  66,  -4,   4, RAMP_FACTION, 2, "right sleeve, out and down"),
    Part(-14,  14,  62,  86,  -8,   8, RAMP_FACTION, 3, "torso"),
    Part( -6,   6,  72,  80, -10,  -8, RAMP_NEUTRAL, 3, "chest emitter"),
    Part(-10,  10,  80,  96,  -6,   6, RAMP_NEUTRAL, 1, "head"),
    Part(-10,  10,  90,  96,  -8,   2, RAMP_NEUTRAL, 3, "implant band"),
    Part( -3,   3,  96, 112,  -2,   2, RAMP_NEUTRAL, 0, "field thread"),
    Part( -8,   8, 110, 124,  -4,   4, RAMP_NEUTRAL, 3, "focus shard"),
    Part( -4,   4, 118, 128,  -2,   2, RAMP_NEUTRAL, 3, "focus shard, tip"),
)
...
DRONE_SWARM: Tuple[Part, ...] = (
    Part(-14,  14,   0,  20,  -9,   9, RAMP_FACTION, 0, "robe hem"),
    Part(-16,  16,   4,  66,   8,  16, RAMP_FACTION, 1, "shroud"),
    Part(-12,  12,  18,  52,  -8,   8, RAMP_FACTION, 2, "robe"),
    Part(-14,  14,  44,  54, -16,  -8, RAMP_NEUTRAL, 2, "control slab"),
    Part( -9,   9,  45,  51, -18, -16, RAMP_NEUTRAL, 3, "control slab, lit strip"),
    Part(-10,  10,  50,  80,  -8,   8, RAMP_FACTION, 3, "torso"),
    Part(-16, -10,  50,  74, -12,  -4, RAMP_FACTION, 1, "left arm, down to the slab"),
    Part( 10,  16,  50,  74, -12,  -4, RAMP_FACTION, 1, "right arm, down to the slab"),
    Part(-29, -19,  64,  76, -10,   2, RAMP_NEUTRAL, 3, "drone, near left"),
    Part( 19,  29,  64,  76, -10,   2, RAMP_NEUTRAL, 3, "drone, near right"),
    Part( -8,   8,  78,  96,  -7,   7, RAMP_NEUTRAL, 1, "head"),
    Part( -8,   8,  84,  90, -10,  -8, RAMP_NEUTRAL, 3, "visor slit"),
    Part(-30, -20,  96, 108,  -4,   8, RAMP_NEUTRAL, 2, "drone, far left"),
    Part( 20,  30,  96, 108,  -4,   8, RAMP_NEUTRAL, 2, "drone, far right"),
    Part(-12,  12, 100, 108,  -4,   4, RAMP_FACTION, 3, "antenna bar"),
    Part(-11,  -7, 106, 124,  -3,   3, RAMP_NEUTRAL, 2, "antenna rod, left"),
    Part(  7,  11, 106, 124,  -3,   3, RAMP_NEUTRAL, 2, "antenna rod, right"),
    Part( -2,   2, 106, 128,  -3,   3, RAMP_NEUTRAL, 2, "antenna rod, centre"),
)
...
MEDIC: Tuple[Part, ...] = (
    Part(-11,  -3,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "left boot"),
    Part(  3,  11,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "right boot"),
    Part(-10,  -4,   6,  36,  -6,   6, RAMP_NEUTRAL, 3, "left shin"),
    Part(  4,  10,   6,  36,  -6,   6, RAMP_NEUTRAL, 3, "right shin"),
    Part(-13,  13,  34,  62,  -9,   9, RAMP_NEUTRAL, 3, "suit, skirt"),
    Part( -6,   6,  34,  62, -11,  -9, RAMP_FACTION, 3, "stole, skirt"),
    Part(-19, -15,  64,  88,  -6,   6, RAMP_NEUTRAL, 3, "left arm"),
    Part(-15,  15,  60,  96, -11,  11, RAMP_NEUTRAL, 3, "suit, dome"),
    Part( 15,  19,  68,  94,  -6,   6, RAMP_NEUTRAL, 3, "right arm"),
    Part( -6,   6,  60,  96, -13, -11, RAMP_FACTION, 3, "stole, chest"),
    Part(-15,  15,  92, 100,  -9,   3, RAMP_FACTION, 2, "shoulder yoke"),
    Part( -7,   7,  96, 112,  -6,   6, RAMP_NEUTRAL, 2, "head"),
    Part( 16,  22,  86, 120,  -6,  -2, RAMP_NEUTRAL, 1, "injector"),
    Part( -8,   8, 100, 106,  -8,  -6, RAMP_NEUTRAL, 0, "visor recess"),
    Part( -8,   8, 107, 113,  -7,   1, RAMP_FACTION, 2, "brow band"),
    Part( 10,  26, 120, 128,  -8,  -2, RAMP_NEUTRAL, 3, "cross, bar"),
    Part( 16,  22, 120, 128, -16,   4, RAMP_NEUTRAL, 3, "cross, stem"),
)
...
CAPTAIN: Tuple[Part, ...] = (
    Part(-11,  -3,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "left boot"),
    Part(  3,  11,   0,   6,  -7,   7, RAMP_NEUTRAL, 0, "right boot"),
    Part(-10,  -4,   6,  38,  -6,   6, RAMP_NEUTRAL, 1, "left shin"),
    Part(  4,  10,   6,  38,  -6,   6, RAMP_NEUTRAL, 1, "right shin"),
    Part(-15,  15,   4,  88,   8,  16, RAMP_FACTION, 1, "command drape"),
    Part(-10,  -3,  36,  60,  -7,   7, RAMP_NEUTRAL, 2, "left thigh"),
    Part(  3,  10,  36,  60,  -7,   7, RAMP_NEUTRAL, 2, "right thigh"),
    Part( 17,  29,  52,  58,   2,  12, RAMP_NEUTRAL, 2, "array element"),
    Part( 20,  26,   0, 114,   4,  10, RAMP_NEUTRAL, 2, "comms mast"),
    Part(-12,  12,  58,  74,  -8,   8, RAMP_FACTION, 2, "hip armour"),
    Part(-17, -12,  72,  94,  -6,   6, RAMP_NEUTRAL, 2, "left arm"),
    Part( 12,  17,  72,  94,  -6,   6, RAMP_NEUTRAL, 2, "right arm"),
    Part(-12,  12,  72, 100, -10,  10, RAMP_FACTION, 3, "cuirass"),
    Part(-22, -15,  78,  86, -12,  -4, RAMP_NEUTRAL, 1, "sidearm"),
    Part( -8,   8,  80,  86, -12, -10, RAMP_NEUTRAL, 3, "rank bars"),
    Part(-24, -18,  80,  90, -14,  -6, RAMP_NEUTRAL, 3, "sidearm, muzzle vent"),
    Part( 26,  30,  92, 112,   0,  16, RAMP_FACTION, 3, "mast pennant"),
    Part(-19, -11,  94, 106,  -9,   9, RAMP_FACTION, 2, "left pauldron"),
    Part( 11,  19,  94, 106,  -9,   9, RAMP_FACTION, 2, "right pauldron"),
    Part( -9,   9, 102, 118,  -9,   9, RAMP_NEUTRAL, 2, "open helm"),
    Part( -9,   9, 106, 112, -11,  -9, RAMP_NEUTRAL, 0, "face recess"),
    Part( 21,  25, 110, 128,   4,  10, RAMP_NEUTRAL, 3, "mast tip"),
    Part( -9,   9, 114, 120,  -9,   9, RAMP_NEUTRAL, 3, "circlet"),
    Part( -3,   3, 116, 128,  -2,  12, RAMP_FACTION, 3, "plume"),
)
...
INFILTRATOR: Tuple[Part, ...] = (
    Part(-15,  -6,   0,   8, -12,   0, RAMP_NEUTRAL, 0, "left boot"),
    Part(  6,  15,   0,   8, -12,   0, RAMP_NEUTRAL, 0, "right boot"),
    Part(-14,  -7,   8,  34, -12,  -2, RAMP_NEUTRAL, 1, "left shin"),
    Part(  7,  14,   8,  34, -12,  -2, RAMP_NEUTRAL, 1, "right shin"),
    Part(-14,  14,   4,  64,   8,  14, RAMP_NEUTRAL, 0, "camouflage shroud"),
    Part(-28,  -8,  30,  38, -22, -16, RAMP_NEUTRAL, 3, "energy blade, low"),
    Part(-13,  -5,  32,  58, -10,   2, RAMP_NEUTRAL, 1, "left thigh"),
    Part(  5,  13,  32,  58, -10,   2, RAMP_NEUTRAL, 1, "right thigh"),
    Part(-12,  12,  56,  72, -14,   0, RAMP_FACTION, 1, "harness"),
    Part(-18, -12,  66,  88, -18,  -6, RAMP_NEUTRAL, 1, "left arm"),
    Part(-12,  12,  70,  96, -14,   0, RAMP_FACTION, 3, "torso"),
    Part( 12,  18,  74,  96, -18,  -6, RAMP_NEUTRAL, 1, "right arm"),
    Part(  8,  28,  86,  94, -22, -16, RAMP_NEUTRAL, 3, "energy blade, high"),
    Part(-15,  15,  96, 104, -14,   0, RAMP_NEUTRAL, 1, "mantle"),
    Part(-10,  10,  94, 102, -16,  -6, RAMP_FACTION, 3, "throat plate"),
    Part( -9,   9, 100, 122, -20,  -8, RAMP_NEUTRAL, 0, "hood"),
    Part( -7,   7, 106, 111, -22, -20, RAMP_NEUTRAL, 3, "eye slits"),
    Part( -7,   7, 118, 128, -18, -10, RAMP_NEUTRAL, 0, "hood crown"),
)
...
XENOFORM: Tuple[Part, ...] = (
    Part(-16,  -9,   0,  44,   6,  14, RAMP_NEUTRAL, 0, "rear leg, far"),
    Part( -3,   4,   0,  44,   6,  14, RAMP_NEUTRAL, 0, "middle leg, far"),
    Part( 10,  17,   0,  44,   6,  14, RAMP_NEUTRAL, 0, "front leg, far"),
    Part(-16,  -9,   0,  44, -18, -10, RAMP_NEUTRAL, 1, "rear leg, near"),
    Part( -3,   4,   0,  44, -18, -10, RAMP_NEUTRAL, 1, "middle leg, near"),
    Part( 10,  17,   0,  44, -18, -10, RAMP_NEUTRAL, 1, "front leg, near"),
    Part(-18,  20,  40,  76, -16,  12, RAMP_NEUTRAL, 1, "carapace body"),
    Part( 28,  35,  50,  58, -18,  -8, RAMP_NEUTRAL, 1, "mandible, lower"),
    Part( 21,  31,  52,  78, -12,   4, RAMP_NEUTRAL, 2, "head"),
    Part( 15,  21,  58,  80, -10,   2, RAMP_FACTION, 2, "neck plate"),
    Part(-22, -12,  62,  80,  -6,   4, RAMP_NEUTRAL, 1, "tail, root"),
    Part( 28,  35,  62,  70, -18,  -8, RAMP_NEUTRAL, 1, "mandible, upper"),
    Part( 23,  31,  66,  74, -16, -12, RAMP_NEUTRAL, 3, "eye cluster"),
    Part(-17,  -9,  76,  92,  -6,   4, RAMP_FACTION, 3, "carapace plate, rear"),
    Part( -4,   4,  76,  92,  -6,   4, RAMP_FACTION, 3, "carapace plate, middle"),
    Part(  9,  17,  76,  92,  -6,   4, RAMP_FACTION, 3, "carapace plate, front"),
    Part(-27, -19,  78,  98,  -6,   4, RAMP_NEUTRAL, 1, "tail, middle"),
    Part(-28, -20,  94, 114,  -6,   4, RAMP_NEUTRAL, 1, "tail, upper"),
    Part(-27, -19, 110, 128,  -8,   2, RAMP_NEUTRAL, 3, "stinger"),
)
