...
BADGER_GUARD: Tuple[Part, ...] = (
    Part(-14,  -4,   0,   8,  -8,   8, RAMP_NEUTRAL, 0, "left paw"),
    Part(  4,  14,   0,   8,  -8,   8, RAMP_NEUTRAL, 0, "right paw"),
    Part(-13,  -5,   8,  38,  -6,   6, RAMP_NEUTRAL, 1, "left shin"),
    Part(  5,  13,   8,  38,  -6,   6, RAMP_NEUTRAL, 1, "right shin"),
    Part(-14,  -4,  36,  60,  -7,   7, RAMP_NEUTRAL, 1, "left haunch"),
    Part(  4,  14,  36,  60,  -7,   7, RAMP_NEUTRAL, 1, "right haunch"),
    Part(-13,  13,  58,  82,  -9,   9, RAMP_FACTION, 3, "belly"),
    Part(-26,  -8,  34,  98, -12,  -8, RAMP_NEUTRAL, 2, "shield, bark rim"),
    Part(-23, -11,  44,  88, -15, -12, RAMP_FACTION, 2, "shield, faction field"),
    Part(-19, -15,  62,  76, -18, -15, RAMP_NEUTRAL, 3, "shield, boss"),
    Part(-12,  12,  80, 102, -10,  10, RAMP_NEUTRAL, 1, "chest"),
    Part( 12,  24,  84,  94, -14, -10, RAMP_NEUTRAL, 2, "spear, haft"),
    Part(-19, -11,  92, 104,  -9,   9, RAMP_NEUTRAL, 1, "left shoulder"),
    Part( 11,  19,  92, 104,  -9,   9, RAMP_NEUTRAL, 1, "right shoulder"),
    Part( 20,  28,  96, 108, -14, -10, RAMP_NEUTRAL, 2, "spear, haft raised"),
    Part(-12,  12, 100, 124, -10,  10, RAMP_NEUTRAL, 1, "head"),
    Part( -5,   5, 104, 114, -15, -10, RAMP_NEUTRAL, 2, "muzzle"),
    Part( -2,   2, 105, 110, -17, -15, RAMP_NEUTRAL, 0, "nose"),
    Part(-13,  -7, 118, 128,   0,   8, RAMP_NEUTRAL, 1, "left ear"),
    Part(  7,  13, 118, 128,   0,   8, RAMP_NEUTRAL, 1, "right ear"),
    Part( 22,  28, 106, 124, -15, -10, RAMP_NEUTRAL, 3, "spear, head"),
    Part( -4,   4, 112, 124, -14, -11, RAMP_NEUTRAL, 3, "mask stripe"),
)
...
ARCHER_CAT: Tuple[Part, ...] = (
    Part(-13,  -5,   0,   8,  -8,   8, RAMP_NEUTRAL, 0, "left paw"),
    Part(  5,  13,   0,   8,  -8,   8, RAMP_NEUTRAL, 0, "right paw"),
    Part(-12,  -6,   8,  38,  -6,   6, RAMP_NEUTRAL, 2, "left shin"),
    Part(  6,  12,   8,  38,  -6,   6, RAMP_NEUTRAL, 2, "right shin"),
    Part( 12,  26,  26,  36,   4,  12, RAMP_NEUTRAL, 2, "tail, out"),
    Part( 20,  28,  34,  54,   6,  14, RAMP_NEUTRAL, 2, "tail, curl"),
    Part(-24, -16,   8,  64,  -8,   0, RAMP_NEUTRAL, 1, "bow, lower limb"),
    Part(-12,  -4,  36,  60,  -7,   7, RAMP_NEUTRAL, 2, "left haunch"),
    Part(  4,  12,  36,  60,  -7,   7, RAMP_NEUTRAL, 2, "right haunch"),
    Part(-11,  11,  58,  90,  -8,   8, RAMP_FACTION, 3, "torso"),
    Part(  8,  14,  70,  88, -10,  -2, RAMP_NEUTRAL, 2, "right arm"),
    Part(-18,  -8,  74,  82, -12,  -4, RAMP_NEUTRAL, 2, "left arm, drawing"),
    Part( 10,  16,  74, 106,   4,  12, RAMP_NEUTRAL, 1, "quiver"),
    Part(-24, -16,  62, 116,  -8,   0, RAMP_NEUTRAL, 1, "bow, upper limb"),
    Part(-11,  11,  86,  94, -11,  -8, RAMP_FACTION, 2, "collar"),
    Part( -9,   9,  92, 112,  -8,   8, RAMP_NEUTRAL, 2, "head"),
    Part( -4,   4,  95, 104, -14,  -8, RAMP_NEUTRAL, 1, "muzzle"),
    Part( -2,   2,  96, 101, -16, -14, RAMP_NEUTRAL, 0, "nose"),
    Part(-10,  -4, 108, 128,   0,   8, RAMP_NEUTRAL, 2, "left ear"),
    Part(  4,  10, 108, 128,   0,   8, RAMP_NEUTRAL, 2, "right ear"),
)
...
MAGE_BEAR: Tuple[Part, ...] = (
    Part(-14,  14,   0,  18,  -9,   9, RAMP_NEUTRAL, 1, "robe hem"),
    Part(-19, -13,   0,  58,  -6,   2, RAMP_NEUTRAL, 1, "staff, lower"),
    Part(-13,  13,  16,  50,  -9,   9, RAMP_NEUTRAL, 1, "robe skirt"),
    Part( -5,   5,  14,  50, -12,  -9, RAMP_FACTION, 3, "placket, skirt"),
    Part(-18, -12,  50,  60, -12,  -4, RAMP_NEUTRAL, 2, "left paw"),
    Part( 12,  18,  50,  60, -12,  -4, RAMP_NEUTRAL, 2, "right paw"),
    Part(-13,  13,  48,  74, -10,  10, RAMP_NEUTRAL, 2, "belly"),
    Part( -5,   5,  48,  74, -13, -10, RAMP_FACTION, 3, "placket, belly"),
    Part(-17, -11,  56,  84,  -8,   4, RAMP_NEUTRAL, 2, "left arm"),
    Part( 11,  17,  56,  84,  -8,   4, RAMP_NEUTRAL, 2, "right arm"),
    Part(-19, -13,  56, 104,  -6,   2, RAMP_NEUTRAL, 1, "staff, upper"),
    Part(-12,  12,  72,  94, -10,  10, RAMP_NEUTRAL, 2, "chest"),
    Part( -5,   5,  72,  94, -13, -10, RAMP_FACTION, 3, "placket, chest"),
    Part(-12,  12,  90,  98, -14, -11, RAMP_FACTION, 2, "collar"),
    Part(-10,  10,  96, 118,  -9,   9, RAMP_NEUTRAL, 2, "head"),
    Part( -5,   5, 100, 110, -15,  -9, RAMP_NEUTRAL, 1, "muzzle"),
    Part(-20, -12, 102, 120,  -8,   4, RAMP_NEUTRAL, 2, "acorn"),
    Part( -2,   2, 101, 106, -17, -15, RAMP_NEUTRAL, 0, "nose"),
    Part(-14,  -8, 110, 124,   2,  10, RAMP_NEUTRAL, 1, "left ear"),
    Part(  8,  14, 110, 124,   2,  10, RAMP_NEUTRAL, 1, "right ear"),
    Part(-18, -14, 118, 128,  -7,   3, RAMP_NEUTRAL, 3, "acorn cap"),
)
...
STORM_STAG: Tuple[Part, ...] = (
    Part(-15,  15,   0,  24, -10,  10, RAMP_FACTION, 2, "robe hem"),
    Part(-13,  13,  22,  52,  -9,   9, RAMP_FACTION, 2, "robe"),
    Part( -6,   6,  22,  52, -12,  -9, RAMP_FACTION, 3, "tabard, skirt"),
    Part(-12,  12,  50,  84,  -9,   9, RAMP_NEUTRAL, 2, "torso"),
    Part( -6,   6,  50,  84, -12,  -9, RAMP_FACTION, 3, "tabard, chest"),
    Part(-26, -12,  76,  86,  -6,   4, RAMP_NEUTRAL, 2, "left arm, out"),
    Part( 12,  26,  76,  86,  -6,   4, RAMP_NEUTRAL, 2, "right arm, out"),
    Part(-32, -24,  76,  88,  -8,   2, RAMP_NEUTRAL, 2, "left paw"),
    Part( 24,  32,  76,  88,  -8,   2, RAMP_NEUTRAL, 2, "right paw"),
    Part(-32, -22,  88,  98,   0,  12, RAMP_NEUTRAL, 1, "leaves, loosed left"),
    Part( 22,  32,  88,  98,   0,  12, RAMP_NEUTRAL, 1, "leaves, loosed right"),
    Part( -8,   8,  84,  90, -12,  -9, RAMP_FACTION, 3, "collar"),
    Part( -9,   9,  88, 108,  -9,   9, RAMP_NEUTRAL, 2, "head"),
    Part( -3,   3,  93,  99, -13,  -9, RAMP_NEUTRAL, 0, "muzzle"),
    Part(-26,  -8, 104, 116,   2,  12, RAMP_NEUTRAL, 3, "antler beam, left"),
    Part(  8,  26, 104, 116,   2,  12, RAMP_NEUTRAL, 3, "antler beam, right"),
    Part(-30, -16, 114, 128,   6,  16, RAMP_NEUTRAL, 3, "antler prongs, left"),
    Part( 16,  30, 114, 128,   6,  16, RAMP_NEUTRAL, 3, "antler prongs, right"),
)
...
HEALER_OWL: Tuple[Part, ...] = (
    Part(-17,  17,   0,  18, -10,  10, RAMP_NEUTRAL, 2, "plumage hem"),
    Part( -9,  -4,   0,   6, -13, -10, RAMP_NEUTRAL, 0, "left talon"),
    Part(  4,   9,   0,   6, -13, -10, RAMP_NEUTRAL, 0, "right talon"),
    Part(-16,  16,  16,  48,  -9,   9, RAMP_NEUTRAL, 2, "body, lower"),
    Part( -5,   5,  16,  48, -12,  -9, RAMP_FACTION, 3, "stole, skirt"),
    Part(-22, -14,  20,  74,  -8,   6, RAMP_NEUTRAL, 3, "left wing, folded"),
    Part( 14,  22,  20,  74,  -8,   6, RAMP_NEUTRAL, 3, "right wing, folded"),
    Part(-15,  15,  46,  82,  -9,   9, RAMP_NEUTRAL, 2, "body, upper"),
    Part( -5,   5,  46,  82, -13, -10, RAMP_FACTION, 3, "stole, chest"),
    Part( 14,  20,  62, 100,   0,   8, RAMP_NEUTRAL, 1, "herb sprig, stem"),
    Part(-15,  15,  82,  90, -13,  -6, RAMP_FACTION, 2, "shoulder yoke"),
    Part( 12,  22,  96, 112,   2,  12, RAMP_NEUTRAL, 1, "herb sprig, head"),
    Part(-14,  14,  88, 116, -10,  10, RAMP_NEUTRAL, 2, "facial disc"),
    Part(-13,  -3,  92, 110, -13, -10, RAMP_NEUTRAL, 3, "disc ring, left"),
    Part(  3,  13,  92, 110, -13, -10, RAMP_NEUTRAL, 3, "disc ring, right"),
    Part( -2,   2, 100, 110, -15, -13, RAMP_NEUTRAL, 0, "beak"),
    Part( -9,   9, 112, 128,  -8,   8, RAMP_NEUTRAL, 2, "crown"),
)
...
LION_WARDEN: Tuple[Part, ...] = (
    Part(-13,  -3,   0,   8,  -8,   8, RAMP_NEUTRAL, 1, "left paw"),
    Part(  3,  13,   0,   8,  -8,   8, RAMP_NEUTRAL, 1, "right paw"),
    Part(-12,  -4,   8,  38,  -6,   6, RAMP_NEUTRAL, 1, "left shin"),
    Part(  4,  12,   8,  38,  -6,   6, RAMP_NEUTRAL, 1, "right shin"),
    Part(-18,  18,   4,  82,   8,  16, RAMP_FACTION, 2, "warden's cloak"),
    Part(-20, -14,  10,  82,  -4,   4, RAMP_NEUTRAL, 1, "spear, haft"),
    Part( 20,  26,   0, 114,   4,  10, RAMP_NEUTRAL, 1, "banner pole"),
    Part(-14,  14,  54,  76,  -9,   9, RAMP_FACTION, 3, "skirt"),
    Part(-12,  12,  68,  76, -13, -10, RAMP_NEUTRAL, 3, "gold belt"),
    Part(-17, -12,  72,  94,  -8,   4, RAMP_NEUTRAL, 1, "left arm"),
    Part( 12,  17,  72,  94,  -8,   4, RAMP_NEUTRAL, 1, "right arm"),
    Part(-12,  12,  74, 100, -10,  10, RAMP_NEUTRAL, 1, "torso"),
    Part(-20, -12,  80, 104,  -6,   4, RAMP_NEUTRAL, 3, "spear, head"),
    Part(-18, -10,  88,  98, -11,   1, RAMP_NEUTRAL, 2, "shoulder stud, left"),
    Part( 10,  18,  88,  98, -11,   1, RAMP_NEUTRAL, 2, "shoulder stud, right"),
    Part( 24,  32,  94, 116,   0,  14, RAMP_FACTION, 3, "banner pennant"),
    Part(-15,  15,  96, 120, -11,  11, RAMP_NEUTRAL, 3, "mane"),
    Part( -8,   8, 100, 116, -14, -11, RAMP_NEUTRAL, 1, "face"),
    Part( -5,   5, 103, 111, -17, -14, RAMP_NEUTRAL, 2, "muzzle"),
    Part( 20,  26, 114, 128,   4,  10, RAMP_NEUTRAL, 3, "banner finial"),
    Part(-12,  -6, 116, 126,   0,   8, RAMP_NEUTRAL, 2, "left ear"),
    Part(  6,  12, 116, 126,   0,   8, RAMP_NEUTRAL, 2, "right ear"),
)
...
STOAT: Tuple[Part, ...] = (
    Part(-14,  -6,   0,  10, -10,   2, RAMP_NEUTRAL, 2, "left paw"),
    Part(  6,  14,   0,  10, -10,   2, RAMP_NEUTRAL, 2, "right paw"),
    Part( 14,  30,  14,  24,   4,  12, RAMP_NEUTRAL, 1, "tail, out"),
    Part(-13,  -7,   8,  32, -10,   0, RAMP_NEUTRAL, 2, "left shin"),
    Part(  7,  13,   8,  32, -10,   0, RAMP_NEUTRAL, 2, "right shin"),
    Part( 24,  30,  22,  38,   6,  14, RAMP_NEUTRAL, 1, "tail, tip"),
    Part(-14,  14,   4,  58,   8,  14, RAMP_NEUTRAL, 1, "mantle"),
    Part(-28, -14,  22,  30, -18, -12, RAMP_NEUTRAL, 3, "bone knife, low"),
    Part(-13,  -5,  30,  54,  -8,   2, RAMP_NEUTRAL, 2, "left thigh"),
    Part(  5,  13,  30,  54,  -8,   2, RAMP_NEUTRAL, 2, "right thigh"),
    Part(-12,  12,  52,  62, -12,   0, RAMP_NEUTRAL, 1, "belt"),
    Part(-11,  11,  60,  88, -10,   6, RAMP_FACTION, 3, "torso"),
    Part(-17, -11,  62,  80, -14,  -2, RAMP_NEUTRAL, 2, "left arm"),
    Part( 11,  17,  70,  88, -14,  -2, RAMP_NEUTRAL, 2, "right arm"),
    Part( -5,   5,  66,  92, -13, -10, RAMP_NEUTRAL, 3, "throat bib"),
    Part(-11,  11,  86,  94, -13, -10, RAMP_FACTION, 2, "chest band"),
    Part( 14,  28,  84,  92, -20, -14, RAMP_NEUTRAL, 3, "bone knife, high"),
    Part( -9,   9,  92, 114,  -9,   9, RAMP_NEUTRAL, 2, "head"),
    Part( -4,   4,  95, 104, -14,  -9, RAMP_NEUTRAL, 3, "muzzle"),
    Part( -2,   2,  96, 101, -16, -14, RAMP_NEUTRAL, 0, "nose"),
    Part( -9,  -3, 110, 128,   0,   8, RAMP_NEUTRAL, 2, "left ear"),
    Part(  3,   9, 110, 128,   0,   8, RAMP_NEUTRAL, 2, "right ear"),
)
...
BOAR: Tuple[Part, ...] = (
    Part(-22, -15,   0,  42,   6,  14, RAMP_NEUTRAL, 0, "rear leg, far"),
    Part( -1,   6,   0,  42,   6,  14, RAMP_NEUTRAL, 0, "front leg, far"),
    Part(-22, -15,   0,  42, -16,  -8, RAMP_NEUTRAL, 1, "rear leg, near"),
    Part( -1,   6,   0,  42, -16,  -8, RAMP_NEUTRAL, 1, "front leg, near"),
    Part(-25, -19,  44,  56,  -2,   6, RAMP_NEUTRAL, 1, "tail"),
    Part(-28, -22,  48,  60,   0,   8, RAMP_FACTION, 3, "tail tuft"),
    Part(-26,  14,  38,  76, -14,  12, RAMP_NEUTRAL, 1, "body"),
    Part( 24,  34,  48,  64, -18,  -8, RAMP_NEUTRAL, 1, "snout"),
    Part( 16,  32,  44,  82, -12,   8, RAMP_NEUTRAL, 1, "head"),
    Part( 28,  34,  60,  74,  -8,  -2, RAMP_NEUTRAL, 2, "tusk, far"),
    Part( 26,  32,  56,  68, -20, -16, RAMP_NEUTRAL, 2, "tusk, near"),
    Part( 18,  24,  72,  78, -14, -12, RAMP_NEUTRAL, 3, "eye"),
    Part(-24, -20,  76, 104,  -4,   4, RAMP_FACTION, 3, "bristle, rump"),
    Part(-15, -11,  76, 104,  -4,   4, RAMP_FACTION, 3, "bristle, loin"),
    Part( -6,  -2,  76, 128,  -4,   4, RAMP_FACTION, 3, "bristle, back"),
    Part(  3,   7,  76, 128,  -4,   4, RAMP_FACTION, 3, "bristle, shoulder"),
    Part( 12,  16,  76, 128,  -4,   4, RAMP_FACTION, 3, "bristle, nape"),
)
