...
SAMURAI: Tuple[Part, ...] = (
    Part(-16,  -6,   0,   5,  -5,   5, RAMP_NEUTRAL, 1, "left sabaton"),
    Part(  6,  16,   0,   5,  -5,   5, RAMP_NEUTRAL, 1, "right sabaton"),
    Part(-14,  -6,   5,  28,  -4,   4, RAMP_NEUTRAL, 1, "left suneate"),
    Part(  6,  14,   5,  28,  -4,   4, RAMP_NEUTRAL, 1, "right suneate"),
    Part(-17,  17,  27,  40,  -6,   6, RAMP_FACTION, 1, "kusazuri"),
    Part(-13,  13,  39,  64,  -6,   6, RAMP_FACTION, 2, "do"),
    Part(-32,  22,  48,  51, -10,  -6, RAMP_NEUTRAL, 2, "naginata haft, level"),
    Part( 22,  33,  51,  56, -10,  -6, RAMP_NEUTRAL, 3, "naginata blade"),
    Part(-24, -13,  54,  67,  -5,   5, RAMP_NEUTRAL, 1, "left sode"),
    Part( 13,  24,  54,  67,  -5,   5, RAMP_NEUTRAL, 1, "right sode"),
    Part(-13,  13,  57,  60,  -8,  -6, RAMP_FACTION, 3, "odoshi lacing"),
    Part(-14,  14,  60,  68,  -4,   5, RAMP_NEUTRAL, 1, "shikoro"),
    Part(-24, -13,  67,  69,  -5,   5, RAMP_FACTION, 3, "left sode, laced edge"),
    Part( 13,  24,  67,  69,  -5,   5, RAMP_FACTION, 3, "right sode, laced edge"),
    Part( -9,   9,  62,  74,  -8,  -1, RAMP_NEUTRAL, 3, "face"),
    Part(-11,  11,  71,  82,  -5,   5, RAMP_NEUTRAL, 0, "kabuto"),
)
...
YUMI_ARCHER: Tuple[Part, ...] = (
    Part(-13,  -4,   0,   6,  -6,   6, RAMP_NEUTRAL, 1, "left sabaton"),
    Part(  4,  13,   0,   6,  -6,   6, RAMP_NEUTRAL, 1, "right sabaton"),
    Part(-12,  -5,   6,  32,  -4,   4, RAMP_FACTION, 1, "left shin"),
    Part(  5,  12,   6,  32,  -4,   4, RAMP_FACTION, 1, "right shin"),
    Part(-22, -18,  17,  42,   1,   6, RAMP_NEUTRAL, 1, "yumi, lower limb"),
    Part(-14,  14,  30,  42,  -6,   6, RAMP_FACTION, 1, "haidate"),
    Part( 13,  19,  43,  66,   4,   9, RAMP_NEUTRAL, 1, "ebira"),
    Part(-16, -12,  43,  60,  -4,   4, RAMP_FACTION, 1, "left sleeve"),
    Part( 12,  16,  43,  60,  -4,   4, RAMP_FACTION, 1, "right sleeve"),
    Part(-12,  12,  40,  68,  -6,   6, RAMP_FACTION, 2, "do"),
    Part(-12,  12,  52,  56,  -8,  -6, RAMP_FACTION, 3, "obi"),
    Part(-27, -20,  40,  92,   1,   6, RAMP_NEUTRAL, 1, "yumi, upper limb"),
    Part( 13,  19,  66,  75,   6,  10, RAMP_NEUTRAL, 3, "fletching"),
    Part( -8,   8,  63,  78,  -9,  -1, RAMP_NEUTRAL, 1, "face"),
    Part(-15,  15,  75,  78,  -6,   6, RAMP_NEUTRAL, 2, "jingasa, brim"),
    Part( -7,   7,  78,  83,  -4,   4, RAMP_NEUTRAL, 2, "jingasa, crown"),
)
...
ONMYOJI: Tuple[Part, ...] = (
    Part(-14,  14,   0,  44,  -6,   6, RAMP_FACTION, 1, "robe, skirt"),
    Part( -4,   4,   3,  44,  -8,  -6, RAMP_FACTION, 3, "fold, skirt"),
    Part(-16, -11,  35,  41,  -7,  -2, RAMP_NEUTRAL, 2, "left hand"),
    Part( 11,  16,  35,  41,  -7,  -2, RAMP_NEUTRAL, 2, "right hand"),
    Part(-16, -11,  40,  58,  -5,   5, RAMP_FACTION, 1, "left sleeve"),
    Part( 11,  16,  40,  58,  -5,   5, RAMP_FACTION, 1, "right sleeve"),
    Part( 14,  19,  35,  84,   2,   6, RAMP_NEUTRAL, 1, "shaku"),
    Part(-11,  11,  43,  72,  -5,   5, RAMP_FACTION, 2, "robe, chest"),
    Part( -4,   4,  44,  72,  -8,  -5, RAMP_FACTION, 3, "fold, chest"),
    Part(-12,  12,  69,  72,  -8,  -6, RAMP_NEUTRAL, 3, "collar"),
    Part( 19,  26,  70,  87,   3,   8, RAMP_NEUTRAL, 3, "ofuda"),
    Part( -8,   8,  70,  86,  -9,  -2, RAMP_NEUTRAL, 2, "face"),
    Part( -6,   6,  81,  84,  -5,  -4, RAMP_NEUTRAL, 3, "eboshi cord"),
    Part( -4,   4,  81,  98,  -4,   2, RAMP_NEUTRAL, 0, "eboshi"),
)
...
KAGURA_DANCER: Tuple[Part, ...] = (
    Part(-20,  20,   0,  17,  -7,   7, RAMP_FACTION, 1, "hakama, hem"),
    Part(-18,  18,  16,  38,  -6,   6, RAMP_FACTION, 2, "hakama"),
    Part(-31, -21,  22,  38,  -4,   4, RAMP_NEUTRAL, 3, "left furisode, outer"),
    Part( 21,  31,  27,  43,  -4,   4, RAMP_NEUTRAL, 3, "right furisode, outer"),
    Part(-24, -16,  33,  48,  -4,   4, RAMP_NEUTRAL, 3, "left furisode, inner"),
    Part( 16,  24,  34,  50,  -4,   4, RAMP_NEUTRAL, 3, "right furisode, inner"),
    Part(-14,  14,  38,  43,  -7,  -6, RAMP_FACTION, 3, "obi"),
    Part(-11,  11,  39,  63,  -5,   5, RAMP_NEUTRAL, 3, "kimono"),
    Part( 19,  25,  51,  68,  -4,   1, RAMP_NEUTRAL, 3, "raised sleeve"),
    Part( 20,  26,  67,  71,  -4,   0, RAMP_NEUTRAL, 2, "hand"),
    Part(-12,  -8,  64,  76,  -4,   3, RAMP_NEUTRAL, 0, "hair, left side"),
    Part(  8,  12,  64,  76,  -4,   3, RAMP_NEUTRAL, 0, "hair, right side"),
    Part( 22,  32,  69,  78,   1,   7, RAMP_NEUTRAL, 1, "suzu"),
    Part( -8,   8,  64,  74,  -8,  -1, RAMP_NEUTRAL, 2, "face"),
    Part( -9,   9,  73,  76,  -6,  -5, RAMP_FACTION, 3, "brow band"),
    Part(-11,  11,  74,  84,  -4,   5, RAMP_NEUTRAL, 0, "hair, crown"),
)
...
TEMPLE_MONK: Tuple[Part, ...] = (
    Part(-13,  13,   0,  20,  -5,   5, RAMP_NEUTRAL, 3, "robe, hem"),
    Part(-15,  15,  19,  39,  -5,   5, RAMP_NEUTRAL, 3, "robe, skirt"),
    Part(-21, -15,  33,  39,  -6,  -2, RAMP_NEUTRAL, 2, "left hand"),
    Part( 15,  21,  33,  39,  -6,  -2, RAMP_NEUTRAL, 2, "right hand"),
    Part(-22, -16,  13,  75,   0,   4, RAMP_NEUTRAL, 1, "shakujo"),
    Part(-16,  16,  37,  52,  -5,   5, RAMP_NEUTRAL, 3, "robe, waist"),
    Part(-20, -15,  40,  56,  -4,   4, RAMP_NEUTRAL, 3, "left sleeve"),
    Part( 15,  20,  40,  56,  -4,   4, RAMP_NEUTRAL, 3, "right sleeve"),
    Part( -4,  16,  39,  52,  -7,  -5, RAMP_FACTION, 2, "kesa, lower"),
    Part(-18,  18,  51,  64,  -6,   6, RAMP_NEUTRAL, 3, "robe, shoulders"),
    Part(-16,   4,  52,  64,  -8,  -6, RAMP_FACTION, 2, "kesa, upper"),
    Part(-15,  15,  59,  63,  -8,  -6, RAMP_FACTION, 3, "collar"),
    Part(-24, -19,  64,  73,   0,   3, RAMP_NEUTRAL, 3, "shakujo, paper"),
    Part( -9,   9,  63,  79,  -8,   0, RAMP_NEUTRAL, 2, "shaved skull"),
    Part( -7,   7,  71,  72,  -9,  -8, RAMP_NEUTRAL, 0, "brow"),
    Part(-26, -14,  73,  85,   1,   5, RAMP_NEUTRAL, 3, "shakujo, rings"),
)
...
DAIMYO: Tuple[Part, ...] = (
    Part(-14,  -5,   0,   5,  -5,   5, RAMP_NEUTRAL, 1, "left sabaton"),
    Part(  5,  14,   0,   5,  -5,   5, RAMP_NEUTRAL, 1, "right sabaton"),
    Part(-12,  -5,   5,  25,  -4,   4, RAMP_NEUTRAL, 1, "left suneate"),
    Part(  5,  12,   5,  25,  -4,   4, RAMP_NEUTRAL, 1, "right suneate"),
    Part(-20,  20,  11,  33,  -6,   6, RAMP_FACTION, 1, "jinbaori, hem"),
    Part(-26, -12,  21,  25,  -8,  -5, RAMP_NEUTRAL, 3, "tachi"),
    Part(-18,  18,  31,  46,  -5,   5, RAMP_FACTION, 2, "jinbaori"),
    Part(  8,  13,  38,  66,   6,  10, RAMP_NEUTRAL, 1, "sashimono, staff"),
    Part(-13,  13,  41,  64,  -6,   6, RAMP_NEUTRAL, 0, "do"),
    Part(-13,  13,  49,  53,  -8,  -6, RAMP_FACTION, 3, "odoshi lacing"),
    Part(-21, -13,  53,  61,  -5,   4, RAMP_NEUTRAL, 1, "left sode"),
    Part( 13,  21,  53,  61,  -5,   4, RAMP_NEUTRAL, 1, "right sode"),
    Part(-13,  13,  65,  75,   6,  16, RAMP_FACTION, 2, "sashimono"),
    Part(-14,  14,  61,  69,  -4,   6, RAMP_NEUTRAL, 0, "shikoro"),
    Part( -4,   4,  74,  76,   8,  13, RAMP_NEUTRAL, 3, "mon"),
    Part( -9,   9,  61,  73,  -8,  -1, RAMP_NEUTRAL, 2, "face"),
    Part(-11,  11,  69,  80,  -5,   5, RAMP_NEUTRAL, 0, "kabuto"),
    Part( -9,   9,  73,  79,  -8,  -6, RAMP_NEUTRAL, 3, "maedate"),
)
...
SHINOBI: Tuple[Part, ...] = (
    Part(-24, -14,   0,  22,  -5,   2, RAMP_NEUTRAL, 1, "left shin"),
    Part( 14,  24,   0,  22,  -5,   2, RAMP_NEUTRAL, 1, "right shin"),
    Part(-26, -13,  16,  21, -10,  -6, RAMP_NEUTRAL, 2, "scabbard, chape"),
    Part(-21, -12,  21,  35,  -5,   2, RAMP_NEUTRAL, 1, "left thigh"),
    Part( 12,  21,  21,  35,  -5,   2, RAMP_NEUTRAL, 1, "right thigh"),
    Part(-15,  15,  20,  36,  -7,  -2, RAMP_NEUTRAL, 0, "kilt"),
    Part(-14,  14,  33,  38,  -9,  -4, RAMP_FACTION, 3, "obi"),
    Part(-19, -13,  37,  49,  -6,   0, RAMP_NEUTRAL, 1, "left arm"),
    Part( 13,  19,  37,  49,  -6,   0, RAMP_NEUTRAL, 1, "right arm"),
    Part(-13,  13,  36,  54,  -6,   4, RAMP_NEUTRAL, 1, "torso"),
    Part(-11,  11,  37,  53,  -9,  -6, RAMP_NEUTRAL, 0, "breast"),
    Part(-11,  11,  53,  58,  -7,   2, RAMP_NEUTRAL, 2, "collar"),
    Part( 12,  22,  55,  60, -11,  -7, RAMP_NEUTRAL, 3, "tsuba"),
    Part(-11,  11,  57,  72,  -5,   4, RAMP_NEUTRAL, 1, "zukin"),
    Part(-10,  10,  62,  65,  -6,  -5, RAMP_FACTION, 3, "mask band"),
    Part( 20,  28,  59,  67, -11,  -7, RAMP_FACTION, 3, "grip, wrapped"),
    Part( -8,   8,  69,  79,  -2,   5, RAMP_NEUTRAL, 1, "zukin, crown"),
)
...
SHRINE_FOX: Tuple[Part, ...] = (
    Part(-18, -10,   0,  24,   2,   7, RAMP_NEUTRAL, 0, "hind leg, far"),
    Part(  6,  14,   0,  24,   2,   7, RAMP_NEUTRAL, 0, "fore leg, far"),
    Part(-14,  -6,   0,  24,  -8,  -3, RAMP_NEUTRAL, 1, "hind leg, near"),
    Part( 10,  18,   0,  24,  -8,  -3, RAMP_NEUTRAL, 1, "fore leg, near"),
    Part(-20,  20,  22,  42,  -8,   6, RAMP_NEUTRAL, 1, "body, long in x"),
    Part(-24, -12,  27,  44,   0,   4, RAMP_NEUTRAL, 1, "tail, root"),
    Part( 14,  24,  26,  40,  -7,   2, RAMP_NEUTRAL, 1, "chest"),
    Part( 16,  28,  27,  36,  -9,  -6, RAMP_FACTION, 3, "bib"),
    Part( 19,  34,  34,  44,  -7,   1, RAMP_NEUTRAL, 2, "skull"),
    Part( 26,  36,  33,  39, -10,  -7, RAMP_NEUTRAL, 3, "muzzle"),
    Part(-14,  14,  40,  43,  -6,   4, RAMP_FACTION, 2, "votive cloth"),
    Part( 19,  24,  43,  52,   0,   3, RAMP_NEUTRAL, 2, "left ear"),
    Part( 29,  34,  43,  52,   0,   3, RAMP_NEUTRAL, 2, "right ear"),
    Part(-27, -19,  42,  60,   1,   6, RAMP_NEUTRAL, 2, "tail, brush"),
    Part(-29, -23,  59,  71,   2,   7, RAMP_NEUTRAL, 3, "tail, white tip"),
)
