...
inline constexpr std::uint16_t tarnholt_campaign_found[] = {
    ...
    pad_a, pad_a, pad_start, pad_a, pad_b, pad_right,
    pad_right, pad_a, pad_left, pad_left, pad_left, pad_down,
    pad_a, pad_b, pad_right, pad_right, pad_up, pad_a,
    pad_left, pad_left, pad_down, pad_down, pad_a, pad_b,
    pad_right, pad_right, pad_right, pad_a, pad_left, pad_left,
    pad_down, pad_a, pad_b, pad_right, pad_right, pad_a,
    pad_up, pad_up, pad_up, pad_a, pad_b, pad_right,
    pad_right, pad_right, pad_right, pad_a, pad_left, pad_left,
    pad_left, pad_left, pad_left, pad_a, pad_b, pad_right,
    pad_right, pad_down, pad_a, pad_left, pad_down, pad_a,
    pad_b, pad_right, pad_right, pad_a, pad_a, pad_b,
    pad_a, pad_left, pad_left, pad_left, pad_down, pad_a,
    pad_b, pad_right, pad_up, pad_a, pad_a, pad_b,
    pad_a, pad_left, pad_left, pad_left, pad_up, pad_up,
    pad_a, pad_b, pad_right, pad_right, pad_right, pad_a,
    pad_left, pad_left, pad_down, pad_a, pad_b, pad_right,
    pad_right, pad_a, pad_a, pad_b, pad_a, pad_left,
    pad_left, pad_down, pad_down, pad_a, pad_b, pad_right,
    pad_right, pad_a, pad_left, pad_left, pad_left, pad_up,
    pad_up, pad_a, pad_b, pad_right, pad_down, pad_a,
    pad_left, pad_up, pad_a, pad_b, pad_right, pad_right,
    pad_right, pad_down, pad_a, pad_a, pad_b, pad_down,
    pad_down, pad_down, pad_a, pad_left, pad_left, pad_up,
    pad_up, pad_a, pad_b, pad_down, pad_down, pad_a,
    pad_a, pad_a, pad_a,
};
